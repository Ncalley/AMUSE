 ...
 * @version $Id: RemoveMostCorrelatedFeature.java 197 2017-08-11 12:15:34Z frederik-h $
 */
		...
		try {
			...
			for(int i=0;i<correlationTableSet.getValueCount();i++) {
				...
				if(firstFeatureIsInTable && secondFeatureIsInTable) {
					...
					// here it is the same for pairs (mean partition value of zc; mean partition value of sc),
					// (mean partition value of zc; stddev partition value of sc), (stddev partition value of zc; mean partition value of sc)
					// and (stddev partition value of zc; stddev partition value of sc)
